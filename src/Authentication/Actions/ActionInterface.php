 ...
 * They can be phone activation steps, SMS-based 2FA, etc.
 */
interface ActionInterface
{
    /**
     * Shows the initial screen to the user to start the flow.
     * This might be asking for the user's phone to reset a password,
     ...
     * from clicking the 'confirm my phone' action or
