...
class NothingPersonalValidator extends BaseValidator implements ValidatorInterface
{
     ...
     * or the user's phone. Otherwise, it returns false.
     ...
     * comes from CodeIgniter\Shield\Entities\User properties username and phone.
     *
    ...
    protected function isNotPersonal(string $password, ?User $user): bool
    {
        ...
        // Parse out as many pieces as possible from username, password and phone.
        ...
        if ($valid) {
            ...
            // extract parts from phone
			preg_match('/(\d{3})(\d{3})(\d{4})/', $phone, $phoneParts);
			
            $phoneParts[0] = $phoneParts[2] . $phoneParts[3];
			
            $needles = [...$needles, ...$phoneParts];
