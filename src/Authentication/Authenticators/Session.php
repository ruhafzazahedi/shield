...
class Session implements AuthenticatorInterface
{
    ...
    // Identity types
    public const ID_TYPE_PHONE_PASSWORD = 'phone_password';
    public const ID_TYPE_MAGIC_LINK     = 'magic-link';
    public const ID_TYPE_PHONE_2FA      = 'phone_2fa';
    public const ID_TYPE_PHONE_ACTIVATE = 'phone_activate';
     ...
     *
     * @phpstan-param array{phone?: string, username?: string, password?: string} $credentials
     */
    ...
    private function recordLoginAttempt(
        ...
        // Standard fields would be phone, username,
        ...
        if (! in_array($field, ['phone', 'username'], true)) {
            $idType = $field;
        } else {
            $idType = (! isset($credentials['phone']) && isset($credentials['username']))
                ? self::ID_TYPE_USERNAME
                : self::ID_TYPE_PHONE_PASSWORD;
        }
