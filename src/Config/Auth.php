...
class Auth extends BaseConfig
{
    ...
    public string $smsSecretToken = '';
	
    public string $smsBaseUrl = 'https://api.sms.ir/v1/send/';
    ...
    public array $views = [
        ...
        'action_phone_2fa'            => '\CodeIgniter\Shield\Views\phone_2fa_show',
        'action_phone_2fa_verify'     => '\CodeIgniter\Shield\Views\phone_2fa_verify',
        'action_phone_2fa_phone'      => '\CodeIgniter\Shield\Views\Phone\phone_2fa_phone',
        'action_phone_activate_show'  => '\CodeIgniter\Shield\Views\phone_activate_show',
        'action_phone_activate_phone' => '\CodeIgniter\Shield\Views\Phone\phone_activate_phone',
        'magic-link-login'            => '\CodeIgniter\Shield\Views\magic_link_form',
        'magic-link-message'          => '\CodeIgniter\Shield\Views\magic_link_message',
        'magic-link-phone'            => '\CodeIgniter\Shield\Views\Phone\magic_link_phone',
    ];
     ...
     * - register: \CodeIgniter\Shield\Authentication\Actions\PhoneActivator::class
     * - login:    \CodeIgniter\Shield\Authentication\Actions\Phone2FA::class
     *
     ...
     * --------------------------------------------------------------------
     * If true, will allow the use of "magic links" sent via the phone
     ...
     * --------------------------------------------------------------------
     *
     * Do not use string rules like `required|valid_phone`.
     *
     ...
     * being used in passwords. The phone and username fields are always
