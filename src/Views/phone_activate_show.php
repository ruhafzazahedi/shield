...
<?= $this->section('title') ?><?= lang('Auth.phoneActivateTitle') ?> <?= $this->endSection() ?>
...
<div class="container d-flex justify-content-center p-5">
    <div class="card col-12 col-md-5 shadow-sm">
        <div class="card-body">
            <h5 class="card-title mb-5"><?= lang('Auth.phoneActivateTitle') ?></h5>

            <?php if (session('error')) : ?>
                <div class="alert alert-danger"><?= session('error') ?></div>
            <?php endif ?>

            <p><?= lang('Auth.phoneActivateBody') ?></p>
